...
def create_mask():
    mask_from_coords(object_pixels)
...
checkered(canvas,4)
button_start_big_object = Button(root, text='Start Big Object', command=print_obj)
button_end_big_object = Button(root, text='End Big Object')
button_start_sub_object = Button(root, text='Start Sub Object')
button_end_sub_object = Button(root, text='End Sub Object')
